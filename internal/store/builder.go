...
func (b *Builder) buildIngressStore() cache.Store {
	return b.buildStoreFunc(ingressMetricFamilies(b.allowLabelsList["ingresses"], b.allowAnnotationsList["ingresses"]), &networkingv1beta1.Ingress{}, createIngressListWatch)
}
